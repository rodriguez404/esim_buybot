...
async def show_reply_menu(message: types.Message, user_language: str, user_rights: str):
    ...
    if user_rights == "admin":
        keyboard.append([KeyboardButton(text=get_text(user_language, "button.reply_menu.admin"))])
