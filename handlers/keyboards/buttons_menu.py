...
def buttons_local_countries_esim(countries_list: list[list[int]], user_language: str = "ru", page: int = 0, buttons_per_page: int = 16) -> InlineKeyboardMarkup:
    ...
    if page > 0:
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.back"), callback_data=f"countries_list_page_{page - 1}"))
    if end < len(countries_list):
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.next"), callback_data=f"countries_list_page_{page + 1}"))

    if navigation_buttons:
        keyboard.append(navigation_buttons)

    keyboard.append([
        InlineKeyboardButton(text=get_text(user_language, "button.menu"), callback_data="inline_menu_buy_eSIM_callback"),
...
def buttons_local_esim_selected(plans: list[list[int]], country_id: int, user_language: str = "ru", page: int = 0, buttons_per_page: int = 8) -> InlineKeyboardMarkup:
    ...
    navigation_buttons = []
    if page > 0:
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.back"), callback_data=f"selected_country_id_page_{country_id}_{page - 1}"))
    if end < len(plans):
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.next"), callback_data=f"selected_country_id_page_{country_id}_{page + 1}"))
    ...
    keyboard.append([
        InlineKeyboardButton(text=get_text(user_language, "button.menu"), callback_data="local_esim_inline_menu"),
        InlineKeyboardButton(text=get_text(user_language, "button.close"), callback_data="close_inline_menu")
    ])
...
def buttons_region_esim(plans: list[list[int]], user_language: str = "ru", page: int = 0, buttons_per_page: int = 8) -> InlineKeyboardMarkup:
    ...
    if page > 0:
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.back"), callback_data=f"regional_page_{page - 1}"))
    if end < len(plans):
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.next"), callback_data=f"regional_page_{page + 1}"))
...
def buttons_region_esim_selected(plans: list[list[int]], region_id: int, user_language: str = "ru", page: int = 0, buttons_per_page: int = 8) -> InlineKeyboardMarkup:
    ...
    navigation_buttons = []
    if page > 0:
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.back"), callback_data=f"regional_region_page_{region_id}_{page - 1}"))
    if end < len(plans):
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.next"), callback_data=f"regional_region_page_{region_id}_{page + 1}"))

    if navigation_buttons:
        keyboard.append(navigation_buttons)

    keyboard.append([
        InlineKeyboardButton(text=get_text(user_language, "button.menu"), callback_data="region_esim_inline_menu"),
        InlineKeyboardButton(text=get_text(user_language, "button.close"), callback_data="close_inline_menu")
    ])
...
def buttons_global_esim(plans: list[list[int]], user_language: str = "ru", page: int = 0, buttons_per_page: int = 8) -> InlineKeyboardMarkup:
    ...
    navigation_buttons = []
    if page > 0:
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.back"), callback_data=f"global_page_{page - 1}"))
    if end < len(plans):
        navigation_buttons.append(InlineKeyboardButton(text=get_text(user_language, "button.next"), callback_data=f"global_page_{page + 1}"))
